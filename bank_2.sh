...
if [ "" = "$ACTION"   ]; then
    ...
    case "$ACTION" in
        "start")
            ...
            erl \
            +pc unicode \
            -pa $SERVER_ROOT/_build/default/lib/bank/ebin \
            -pa $SERVER_ROOT/_build/default/lib/sync/ebin \
            -boot start_sasl \
            -config ${CONFIG} \
            -name ${MAIN_NODE} \
            -setcookie ${COOKIE} \
        ...
        "startd")
            ...
            erl \
            +pc unicode \
            -pa $SERVER_ROOT/-build/default/lib/bank/ebin \
            -boot start_sasl \
            -config ${CONFIG} \
            -name ${MAIN_NODE} \
            -setcookie ${COOKIE} \
